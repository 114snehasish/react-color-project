...
export default function NewPaletteForm(props) {
    ...
    useEffect(() => {
        ...
        ValidatorForm.addValidationRule('isPaletteNameUnique', (value) => {
            return props.palettes.every(({ paletteName }) => value.toLowerCase() !== paletteName.toLowerCase())
        })
        ...
        <div className={classes.root}>
                ...
                <Toolbar>
                    ...
                    <ValidatorForm onSubmit={savePalette}>
                        <TextValidator
                            ...
                            errorMessages={['Palette Name is required', 'Palette names already used']} />
            ...
            >
                ...
                <ValidatorForm onSubmit={addNewColor} >
                    <TextValidator value={currentName}
                    ...
                    <Button
                        ...
                        variant="contained"
                        color="primary"
                        style={{ backgroundColor: currentColor }}>Add Color</Button>
                </ValidatorForm>
            </Drawer>
            <main
